...
* 🧮 **Balanço Energético Embarcado:** [donicatia1206.github.io](https://donicatia1206.github.io/)
...
* **Mapeamento Emocional:**
  ...
  * **> 120 BPM:** Descarga de adrenalina e agitação (**RAIVA** 🔥)

### 2. Nível de Estresse (0 - 100)
* **Variabilidade da Frequência Cardíaca (HRV):** Mede os intervalos em milissegundos entre batimentos (intervalo R-R).
  * *Alta variação (HRV alta):* Sistema parassimpático ativo (Corpo relaxado / Baixo estresse).
  * *Baixa variação (HRV rígida):* Sistema simpático ativo (Resposta de luta/fuga / Alto estresse).
...
* **Back-end API:** Python / Flask / Flask-CORS (Hospedado no Render)
